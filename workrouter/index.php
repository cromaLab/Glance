...
<head>
	<title>CrowdView Forwarding Window</title>


	<!-- Libraries -->
	<script src="//ajax.aspnetcdn.com/ajax/jQuery/jquery-1.8.1.min.js" type="text/javascript"></script>
...
<body>
	...
	<ul class="instructions">
   		<li> Mark each event you see in the video. </li>
		<li> Add new sliders if there is more than one </li>
